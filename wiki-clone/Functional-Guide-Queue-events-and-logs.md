...
All errors are logged automatically and can be queried here. If information logging is enabled in [Parameters](Functional-Guide-Setup-and-parameters) (or on the processor), information messages appear here too.
