...
All errors are logged automatically and can be queried here. If information logging is enabled on the processor [Processor fields](../field-and-parameter-reference/processor-fields.md), information messages appear here too.
